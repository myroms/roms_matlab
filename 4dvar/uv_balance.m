...
gradPx_bar(1:L,1:M)=0.25.*phix(1:L,1:M).*                                ...
                          (K.pm(1:L ,1:M)  +K.pm(2:Lp,1:M)).*            ...
...
for k=Nm:-1:1,
  ...
  gamma(1:L,1:M)=0.125.*(K.Zr(2:Lp,1:M,k  )-                             ...
                         K.Zr(1:L ,1:M,k  )+                             ...
                         K.Zr(2:Lp,1:M,k+1)-                             ...
                         K.Zr(1:L ,1:M,k+1)).*                           ...
                        (K.Zr(2:Lp,1:M,k+1)-                             ...
  ...
  phix(1:L,1:M)=phix(1:L,1:M)+                                           ...
                fac3.*(((1.0+gamma(1:L,1:M)).*                           ...
                        (deltaR_b(2:Lp,1:M,k+1)-                         ...
...
gradPy_bar(1:L,1:M,N)=0.25.*phie(1:L,1:M).*                              ...
                            (K.pn(1:L,1:M )  +K.pn(1:L,2:Mp)).*          ...
...
for k=Nm:-1:1,
  ...
  gamma(1:L,1:M)=0.125.*(K.Zr(1:L,2:Mp,k  )-                             ...
                         K.Zr(1:L,1:M ,k  )+                             ...
                         K.Zr(1:L,2:Mp,k+1)-                             ...
                         K.Zr(1:L,1:M ,k+1)).*                           ...
                        (K.Zr(1:L,2:Mp,k+1)-                             ...
...
deltaU_b(2:Lm,2:Mm,1:N)=-0.25.*(gradPy(1:Lm-1,1:Mm-1,1:N)+               ...
                                gradPy(2:Lm  ,1:Mm-1,1:N)+               ...
                                gradPy(1:Lm-1,2:Mm  ,1:N)+               ...
                                gradPy(2:Lm  ,2:Mm  ,1:N)).*             ...
                               mask(2:Lm,2:Mm,1:N);

mask=repmat(K.vmask,[1,1,N]);

deltaV_b(2:Lm,2:Mm,1:N)=0.25.*(gradPx(1:Lm-1,1:Mm-1,1:N)+                ...
                               gradPx(2:Lm  ,1:Mm-1,1:N)+                ...
                               gradPx(1:Lm-1,2:Mm  ,1:N)+                ...
                               gradPx(2:Lm  ,2:Mm  ,1:N)).*              ...
                              mask(2:Lm,2:Mm,1:N);
...
zeta_rhs(2:L,2:M)=-K.pm(2:L,2:M).*(GradPx(2:L ,2:M  )-                   ...
                                   GradPx(1:Lm,2:M  ))+                  ...
                   K.pn(2:L,2:M).*(GradPy(2:L ,2:M  )-                   ...
                                   GradPy(2:L ,1:Mm)).*                  ...
                   K.rmask(2:L,2:M);
